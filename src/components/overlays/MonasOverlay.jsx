...
function MonasPreviewModel() {
  ...
  return (
    <primitive
      ref={groupRef}
      object={clonedScene}
      scale={MONAS_PREVIEW_MODEL_SCALE}
      position={MONAS_PREVIEW_MODEL_POSITION}
    />
  );
}

function PreviewCanvas({ className = "w-full h-full" }) {
...
function MonasOverlay({ open, onClose, pageMode = false }) {
  ...
  // Page mode: render as a full-page view (navigated page) with canvas + info panel
  if (pageMode) {
    return (
      <div
        ref={containerRef}
      ...
      >
        ...
        >
          ...
          <div className="flex grow gap-6">
            ...
            <aside className="w-96 shrink-0 space-y-4 overflow-auto bg-slate-800 p-4 text-white/90">
              <p>
                Monas adalah monumen sejarah yang terletak di Jakarta pusat dan
                menjadi simbol perjuangan Indonesia meraih kemerdekaan.
                Puncaknya dilapisi emas dan menjulang setinggi 132 meter.
              </p>
              <p>
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-3 text-white/90">
            ...
            <p>
              Monas adalah monumen sejarah yang terletak di Jakarta pusat dan
              menjadi simbol perjuangan Indonesia meraih kemerdekaan. Puncaknya
              dilapisi emas dan menjulang setinggi 132 meter.
            </p>
            <p>
              Klik dan seret model utama untuk menjelajahi wilayah lain, lalu
              pilih penanda Monas kapan saja untuk kembali melihat detailnya di
              sini.
            </p>
