...
export default {
  ...
  "description": "Monumen yang dibangun di Lapangan Tegallega untuk memperingati peristiwa Bandung Lautan Api, di mana para pejuang membumihanguskan kota Bandung agar tidak dikuasai oleh sekutu.",
  "annotations": [
    {
      "id": 1,
      "position": [-6, 681, 30],
      "title": "Kobaran Api",
      "description": "Bentuk stilasi api di puncak monumen melambangkan semangat perjuangan rakyat Bandung yang terus menyala dan tak pernah padam.",
    ...
    },
    {
      ...
      "description": "Tiga pilar kokoh yang menopang api melambangkan kesatuan antara rakyat, ulama/tokoh agama, dan pejuang/tentara dalam mempertahankan kemerdekaan.",
    ...
    },
    {
      ...
      "description": "Pola lingkaran yang memusat ke arah tiang utama, menggambarkan fokus dan kebulatan tekad seluruh elemen masyarakat menuju satu tujuan: Kemerdekaan.",
