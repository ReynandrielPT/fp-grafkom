...
export default {
  ...
  description:
    "Benteng Rotterdam adalah benteng peninggalan Kerajaan Gowa-Tallo yang kemudian dibangun kembali oleh Belanda di Makassar. Bentuknya menyerupai penyu yang merangkak ke laut.",
  annotations: [
    {
      id: 1,
      position: [0, 2, 0],
      ...
      description:
        "Dinding tebal yang mengelilingi benteng, saksi bisu sejarah panjang kota Makassar.",
    },
    {
      id: 2,
      position: [0, 1, 3],
      ...
      description:
        "Di dalam kompleks benteng terdapat museum yang menyimpan benda-benda bersejarah Sulawesi Selatan.",
    },
  ],
};
