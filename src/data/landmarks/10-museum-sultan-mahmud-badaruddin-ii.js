...
export default {
  ...
  audioUri: audio("museum_sultan_mahmud_badaruddin_ii.mp3"),
  latitude: -2.990934,
  longitude: 104.756371,
  mapScale: scaled(0.15),
  popupScale: popup(1.5),
  objectPosition: [0, -0.515, 0],
  zIndex: 0,
  island: "Sumatra",
  ...
  annotations: [
    {
      ...
      title: "Atap Limasan",
      description:
        "Meskipun berdinding tembok Eropa, atap bangunan ini mempertahankan bentuk Limas (piramida terpotong) yang merupakan ciri khas arsitektur vernakular Palembang.",
    },
    {
      id: 2,
      position: [3, 5, 20],
    ...
    },
    {
      ...
      description:
        "Tubuh bangunan mencerminkan gaya Indische Empire dengan pilar-pilar Doric yang kokoh, plafon tinggi, dan deretan jendela besar (jalousie) untuk ventilasi maksimal. Berbeda dengan rumah tradisional Palembang yang berbahan kayu, struktur utama museum ini menggunakan material bata dan semen yang masif.",
    },
    {
      id: 4,
      position: [0, 1.5, 30],
